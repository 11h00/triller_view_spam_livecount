...
function milestonztest(){
	switch(degar.videos[0].play_count.toString().length){
case 1:
	var milestonz = degar.videos[0].play_count
	milestonz += 1
break;
case 2:
	var milestonz = parseInt((Math.floor(degar.videos[0].play_count / 10)) + "0")
	milestonz += 10
break;
case 3:
	var milestonz = parseInt((Math.floor(degar.videos[0].play_count / 100)) + "00")
	milestonz += 100
break;
case 4:
	var milestonz = parseInt((Math.floor(degar.videos[0].play_count / 1000)) + "000")
	milestonz += 1000
break;
case 5:
	var milestonz = parseInt((Math.floor(degar.videos[0].play_count / 10000)) + "0000")
	milestonz += 10000
break;
case 6:
	var milestonz = parseInt((Math.floor(degar.videos[0].play_count / 100000)) + "00000")
	milestonz += 100000
break;
case 7:
	var milestonz = parseInt((Math.floor(degar.videos[0].play_count / 1000000)) + "000000")
	milestonz += 1000000
break;
case 8:
	var milestonz = parseInt((Math.floor(degar.videos[0].play_count / 10000000)) + "0000000")
	milestonz += 10000000
break;
case 9:
	var milestonz = parseInt((Math.floor(degar.videos[0].play_count / 100000000)) + "00000000")
	milestonz += 100000000
break;
	}
...
odometer5.innerHTML = milestonz - degar.videos[0].play_count
}
function sonsetting(){
if (sonHD == true){
...
CULER.onreadystatechange = function(event) {
    if (this.readyState === XMLHttpRequest.DONE) {
		if (this.status === 200) {
			...
			photo = 100000000 - degar.videos[0].play_count;
			yourcount.innerHTML = degar.videos[0].play_count;
			soundtest()
