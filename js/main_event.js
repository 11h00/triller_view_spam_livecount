...
$("#sole").click(function(){
    if (lanui == false){
        ...
        document.documentElement.style.setProperty('--lightmode_background', "linear-gradient(217deg, rgba(166, 55, 55, 0), rgba(255,0,0,0)), linear-gradient(127deg, rgb(0 0 0 / 80%), rgba(0,255,0,0)), linear-gradient(336deg, rgb(60 0 0 / 92%), rgba(0,0,255,0))");
